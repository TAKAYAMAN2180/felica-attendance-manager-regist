...
public class Main extends JFrame implements ActionListener, WindowListener {
    ...
    Main(boolean hasEntrance, String filePathOfBodyTemperatureSheet) {
        ...
        try (InputStream fis = this.getClass().getResourceAsStream("./data/template.xlsx")) {
    ...
    public void process(String studentNum, String studentName) {
        ...
        if (this.IS_ENTRANCE) {
            ...
            musicFilePath = "./data/ドンドンパフパフ.mp3";
        } else {
            this.labelForInfo.setText("受け付けました。お疲れ様でした。");
            musicFilePath = "./data/「お疲れ様でした」.mp3";
        }
        if(this.IS_ENTRANCE) {
            //体温記録表が提出されているかの確認
            ...
            if(!hasRegistered){
                musicFilePath = "./data/エラー.mp3";
                this.labelForMsg.setText("体温記録表が提出されていません。");
            }else{
